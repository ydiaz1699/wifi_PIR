...
Analiza el código fuente completo que te adjunto (todos los archivos del
repositorio, o el equivalente empaquetado). A partir de él —y **solo** de él—,
genera un archivo `archivo-mapa.yml` (o `repo-map.yml`) con esta estructura:
